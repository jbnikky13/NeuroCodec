...
class LearnedTranslator(nn.Module):
    """Learned latent translator baseline.

    Each target format gets a decoder head. The shared encoder is trained
    across format views, allowing held-out-format experiments later.
    """
